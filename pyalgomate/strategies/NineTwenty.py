...
'''
Deploy 9:20 Straddle and exit at 2 PM
'''


class NineTwenty(BaseOptionsGreeksStrategy):
    def __init__(self, feed, broker, underlying, registeredOptionsCount=0, callback=None, resampleFrequency=None, lotSize=25, collectData=None):
        super(NineTwenty, self).__init__(feed, broker,
        ...
        self.exitTime = datetime.time(hour=14, minute=00)
        self.lotSize = lotSize if lotSize is not None else 15
        self.lots = 10
